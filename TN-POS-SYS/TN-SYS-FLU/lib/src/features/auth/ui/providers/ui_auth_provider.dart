...
class UiAuthLoginLogic extends StateNotifier<UiAuthLoginState> {
  UiAuthLoginLogic() : super(const UiAuthLoginState());
...
// 🇻🇳 Provider cho Login Logic
// 🇺🇸 Login Logic Provider
final uiAuthLoginLogicProvider = StateNotifierProvider<UiAuthLoginLogic, UiAuthLoginState>(
  (ref) => UiAuthLoginLogic(),
);
...
class UiAuthRegisterLogic extends StateNotifier<UiAuthRegisterState> {
  UiAuthRegisterLogic() : super(const UiAuthRegisterState());
...
// 🇻🇳 Provider cho Register Logic
// 🇺🇸 Register Logic Provider
final uiAuthRegisterLogicProvider = StateNotifierProvider<UiAuthRegisterLogic, UiAuthRegisterState>(
  (ref) => UiAuthRegisterLogic(),
);
...
class UiAuthForgotPwdLogic extends StateNotifier<UiAuthForgotPwdState> {
  UiAuthForgotPwdLogic() : super(const UiAuthForgotPwdState());
...
// 🇻🇳 Provider cho Forgot Password Logic
// 🇺🇸 Forgot Password Logic Provider
final uiAuthForgotPwdLogicProvider = StateNotifierProvider<UiAuthForgotPwdLogic, UiAuthForgotPwdState>(
  (ref) => UiAuthForgotPwdLogic(),
);
