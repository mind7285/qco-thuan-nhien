...
BEGIN
    ...
    EXECUTE format('GRANT USAGE ON SCHEMA org TO %I', app_user);
    ...
    EXECUTE format('GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA org TO %I', app_user);
    ...
    EXECUTE format('ALTER DEFAULT PRIVILEGES IN SCHEMA org GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO %I', app_user);
    ...
    EXECUTE format('GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA org TO %I', app_user);
    ...
    EXECUTE format('ALTER DEFAULT PRIVILEGES IN SCHEMA org GRANT EXECUTE ON FUNCTIONS TO %I', app_user);
    ...
    EXECUTE format('GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA org TO %I', app_user);
    ...
    EXECUTE format('ALTER DEFAULT PRIVILEGES IN SCHEMA org GRANT USAGE, SELECT ON SEQUENCES TO %I', app_user);
